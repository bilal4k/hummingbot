...
def maker_trading_pair_prompt():
    exchange = dynamic_grid_config_map.get("exchange").value
...
def order_amount_prompt() -> str:
    trading_pair = dynamic_grid_config_map["market"].value
...
dynamic_grid_config_map = {
    "strategy":
        ConfigVar(key="strategy",
                  prompt=None,
                  default="dynamic_grid"),
    "exchange":
    ...
    "n_levels":
        ConfigVar(key="n_levels",
                  prompt="How many levels do you want on the dynamic_grid (even number)? >>> ",
                  type_str="int",
    ...
    "ask_order_optimization_depth":
        ConfigVar(key="ask_order_optimization_depth",
                  ...
                  required_if=lambda: dynamic_grid_config_map.get("order_optimization_enabled").value,
                  type_str="decimal",
