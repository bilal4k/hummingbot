...
from hummingbot.strategy.dynamic_grid import DynamicGridStrategy
from hummingbot.strategy.dynamic_grid.dynamic_grid_config_map import dynamic_grid_config_map as c_map
...
def start(self):
    try:
        ...
        strategy_logging_options = DynamicGridStrategy.OPTION_LOG_ALL
        self.strategy = DynamicGridStrategy()
